...
class CartSerializer(serializers.ModelSerializer):
    ...
    owner_type=serializers.ReadOnlyField(source='owner_type.id')
    # delivery_fee=serializers.SerializerMethodField()
    class Meta:
        model=Cart
        fields=['owner_type']
        fields=['id','cart_id','owner_type','items','total_item','total',]
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Order
        fields=['id','order_item','total_amount','phone','total_quantity','delivery_fee','order_id','order_status','order_date']
